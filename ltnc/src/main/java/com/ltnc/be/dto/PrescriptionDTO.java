...
public class PrescriptionDTO {
  ...
  private List<PrescriptionMedicineDTO>
      prescriptionMedicines; // Use DTO type for PrescriptionMedicine

  public static PrescriptionDTO fromDomain(
      com.ltnc.be.domain.prescription.Prescription prescription) {
    return PrescriptionDTO.builder()
        ...
        .prescriptionMedicines(
            prescription.getPrescriptionMedicines().stream()
