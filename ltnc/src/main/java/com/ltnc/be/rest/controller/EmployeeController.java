...
public class EmployeeController {
  ...
  public BaseResponse<List<EmployeeResponse>> getAllEmployees(
    ...
    if (searchFlag == Boolean.TRUE) {
      return BaseResponse.of(
          employeeFacade.searchEmployees(fullName, dutyType, department, pageNo, pageSize, sortBy));
    }
  ...
  @ResponseStatus(HttpStatus.OK)
  // @IsAuthenticated
  public BaseResponse<List<EmployeeResponse>> getAllEmployeesManagedByEmployee(
    ...
    if (searchFlag == Boolean.TRUE) {
      return BaseResponse.of(
          employeeFacade.searchAllEmployeesManagedByEmployee(
              managerId, fullName, dutyType, department, pageNo, pageSize, sortBy));
    }
    return BaseResponse.of(
        employeeFacade.getAllEmployeesManagedByEmployee(managerId, pageNo, pageSize, sortBy));
  }
  ...
  @ResponseStatus(HttpStatus.OK)
  // @IsAuthorizedAsAdmin
  public BaseResponse<Void> UpdateEmployee(
      @PathVariable Long employeeId, @RequestBody UpsertEmployeeRequest request) {
