...
public class RoomController {
  ...
  @Operation(tags = "Room APIs")
  @ResponseStatus(HttpStatus.OK)
  public BaseResponse<Void> assignPatientToRoom(
      @PathVariable Long roomId, @PathVariable Long patientId, @RequestParam int bedNumber) {
  ...
  @Operation(tags = "Room APIs")
  @ResponseStatus(HttpStatus.OK)
  public BaseResponse<Void> assignEmployeeToRoom(
      @PathVariable Long roomId, @PathVariable Long employeeId) {
  ...
  @Operation(tags = "Room APIs")
  public BaseResponse<Void> deleteRoomPatient(
      @PathVariable Long roomId, @PathVariable Long patientId) {
  ...
  @Operation(tags = "Room APIs")
  public ResponseEntity<Void> deleteRoomEmployee(
      @PathVariable Long roomId, @PathVariable Long employeeId) {
