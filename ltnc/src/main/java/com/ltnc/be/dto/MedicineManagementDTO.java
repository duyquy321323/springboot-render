...
public class MedicineManagementDTO {
  ...
  public static MedicineManagementDTO fromDomain(
      com.ltnc.be.domain.medicineManagement.MedicineManagement management) {
    return MedicineManagementDTO.builder()
        .id(management.getId())
        .medicineId(management.getMedicine().getId())
        .medicineName(
            management.getMedicine().getName()) // You need to have a getName() method in Medicine
