...
public class PatientController {
  ...
  public BaseResponse<List<PatientResponse>> getAllPatients(
    ...
    if (searchFlag == Boolean.TRUE) {
      return BaseResponse.of(
          patientFacade.searchPatients(fullName, type, pageNo, pageSize, sortBy));
    }
  ...
  @Operation(tags = "Patient APIs")
  @ResponseStatus(HttpStatus.OK)
  public BaseResponse<Void> updatePatient(
      @PathVariable Long patientId, @RequestBody UpsertPatientRequest request) {
