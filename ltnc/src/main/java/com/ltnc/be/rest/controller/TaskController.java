...
public class TaskController {
  ...
  // @IsAuthenticated
  public BaseResponse<List<TaskResponse>> getAllTaskByEmployeeIdAndMonth(
      @RequestParam Long employeeId, @RequestParam int month) {
  ...
  @ResponseStatus(HttpStatus.OK)
  // @IsAuthenticated
  public BaseResponse<Void> updateTask(
      @PathVariable Long taskId, @RequestBody UpsertTaskRequest request) {
